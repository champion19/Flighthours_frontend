...
/// Tail Number Detail Page
///
/// Shows data from GET /tail-numbers/:plate endpoint only:
/// tail_number, model_name, airline_name
class TailNumberDetailPage extends StatelessWidget {
  final TailNumberEntity tailNumber;

  const TailNumberDetailPage({super.key, required this.tailNumber});
                ...
                child: Column(
                  children: [
                    _buildInfoRow(
                      ...
                      value: tailNumber.modelName ?? 'N/A',
                    ),
                    const Divider(height: 1, indent: 16, endIndent: 16),
                    _buildInfoRow(
                      icon: Icons.airlines,
                      label: 'Airline',
                      value: tailNumber.airlineName ?? 'N/A',
                    ),
                  ],
                ),
              ),
