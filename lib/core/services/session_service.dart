...
class SessionService {
  ...
  // ========== PENDING PILOT DATA ==========
  // These methods store pilot data captured during registration
  ...
  /// Saves pilot data to be sent after first login
  ...
  /// Clears the pending pilot data after successful update
