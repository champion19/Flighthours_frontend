...
class _$InjectorApp extends InjectorApp {
  ...
  void _configureAuthFactories() {
    ...
    container
      ...
      ..registerFactory((c) => SearchCrewMembersUseCase(
          repository: c.resolve<CrewMemberRepository>()))
      ..registerFactory((c) => CreateCrewMemberUseCase(
          repository: c.resolve<CrewMemberRepository>()))
      ..registerFactory<CrewMemberRepository>((c) => CrewMemberRepositoryImpl(
          remoteDataSource: c.resolve<CrewMemberRemoteDataSource>()))
      ..registerFactory<CrewMemberRemoteDataSource>(
          (c) => CrewMemberRemoteDataSourceImpl(dio: c.resolve<Dio>()));
  }
}
