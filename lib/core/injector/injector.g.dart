...
class _$InjectorApp extends InjectorApp {
  ...
  void _configureAuthFactories() {
    ...
    container
      ...
      ..registerFactory(
        (c) => UpdateLogbookDetailUseCase(
          repository: c.resolve<LogbookRepository>(),
        ),
      )
      ..registerFactory(
        (c) => DeleteDailyLogbookUseCase(
          repository: c.resolve<LogbookRepository>(),
        ),
      )
      ..registerFactory(
        (c) => CreateDailyLogbookUseCase(
          repository: c.resolve<LogbookRepository>(),
        ),
      )
      ..registerFactory(
        (c) => ActivateDailyLogbookUseCase(
          repository: c.resolve<LogbookRepository>(),
        ),
      )
      ..registerFactory(
        (c) => DeactivateDailyLogbookUseCase(
          repository: c.resolve<LogbookRepository>(),
        ),
      )
      ...
      ..registerFactory<TailNumberRepository>(
        (c) =>
      ...
      ..registerFactory(
        (c) => ListCrewMemberTypesUseCase(
          repository: c.resolve<CrewMemberTypeRepository>(),
        ),
      )
      ..registerFactory<CrewMemberTypeRepository>(
        (c) => CrewMemberTypeRepositoryImpl(
