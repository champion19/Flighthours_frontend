...
class _$InjectorApp extends InjectorApp {
  ...
  void _configureAuthFactories() {
    ...
    container
      ...
      ..registerFactory(
        (c) => DeactivateAirlineUseCase(
          repository: c.resolve<AirlineRepository>(),
        ),
      )
      ..registerFactory<AirlineRepository>(
        (c) => AirlineRepositoryImpl(
      ...
      ..registerFactory(
        (c) => DeactivateAirportUseCase(
          repository: c.resolve<AirportRepository>(),
        ),
      )
      ..registerFactory<AirportRepository>(
        (c) => AirportRepositoryImpl(
      ...
      ..registerFactory(
        (c) => ListAircraftModelUseCase(
          repository: c.resolve<AircraftModelRepository>(),
        ),
      )
      ..registerFactory(
        (c) => GetAircraftModelByIdUseCase(
          repository: c.resolve<AircraftModelRepository>(),
        ),
      )
      ..registerFactory(
        (c) => GetAircraftModelsByFamilyUseCase(
          repository: c.resolve<AircraftModelRepository>(),
        ),
      )
      ..registerFactory(
        (c) => ActivateAircraftModelUseCase(
          repository: c.resolve<AircraftModelRepository>(),
        ),
      )
      ..registerFactory(
        (c) => DeactivateAircraftModelUseCase(
          repository: c.resolve<AircraftModelRepository>(),
        ),
      )
      ..registerFactory<AircraftModelRepository>(
        (c) => AircraftModelRepositoryImpl(
      ...
      ..registerFactory<ResetPasswordRepository>(
        (c) =>
      ...
      ..registerFactory<RouteRepository>(
        (c) => RouteRepositoryImpl(
      ...
      ..registerFactory(
        (c) => ListAirlineRoutesUseCase(
          repository: c.resolve<AirlineRouteRepository>(),
        ),
      )
      ..registerFactory(
        (c) => GetAirlineRouteByIdUseCase(
          repository: c.resolve<AirlineRouteRepository>(),
        ),
      )
      ..registerFactory<AirlineRouteRepository>(
        (c) => AirlineRouteRepositoryImpl(
      ...
      ..registerFactory(
        (c) => ListDailyLogbooksUseCase(
          repository: c.resolve<LogbookRepository>(),
        ),
      )
      ..registerFactory(
        (c) => ListLogbookDetailsUseCase(
          repository: c.resolve<LogbookRepository>(),
        ),
      )
      ..registerFactory(
        (c) => GetLogbookDetailByIdUseCase(
          repository: c.resolve<LogbookRepository>(),
        ),
      )
      ..registerFactory(
        (c) => DeleteLogbookDetailUseCase(
          repository: c.resolve<LogbookRepository>(),
        ),
      )
      ..registerFactory<LogbookRepository>(
        (c) => LogbookRepositoryImpl(
      ...
      ..registerFactory<LicensePlateRepository>(
        (c) => LicensePlateRepositoryImpl(
          c.resolve<LicensePlateRemoteDataSource>(),
        ),
      )
